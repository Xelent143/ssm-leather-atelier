  ...
  if (monogram) {
    ...
    return (
      <span style={{
        ...
        <img
          src="/assets/motogrip-monogram.png"
          alt="MOTOGRIP GEAR"
          style={{
    ...
    <header style={{
      ...
      <div style={{
        ...
        <button onClick={() => go('home')} aria-label="MOTOGRIP GEAR Home"
          ...
          <MotoGripLogo compact={isMobile} monogram />
        </button>
