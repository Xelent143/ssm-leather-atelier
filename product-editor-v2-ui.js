    ...
    return `<div class="pe-page">
      ...
      <form id="pe-form" class="pe-layout">
        <main class="pe-main">
          ...
          <section class="card pe-card"><h2>Category</h2><div class="pe-grid-2">${input('Category', 'organization.category', product.organization.category, 'text', 'required')}${select('Gender', 'organization.gender', product.organization.gender, ['Men', 'Women', 'Unisex'])}</div></section>
